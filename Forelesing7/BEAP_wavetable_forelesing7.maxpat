...
,
		"classnamespace" : "box",
		"rect" : [ 1021.0, 253.0, 1136.0, 772.0 ],
		"bglocked" : 0,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 478.0, 566.0, 271.0, 114.0 ],
					"varname" : "bp.Reverb 2",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 179.5, 287.0, 90.0, 116.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 23.0, 287.0, 137.0, 116.0 ],
					"varname" : "bp.LFO",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 410.0, 429.0, 381.0, 116.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 23.0, 429.0, 381.0, 116.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 23.0, 566.0, 295.0, 116.0 ],
					"varname" : "bp.Ladder",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 340.0, 566.0, 113.0, 116.0 ],
					"varname" : "bp.VCA",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 293.5, 287.0, 100.0, 116.0 ],
					"varname" : "bp.AD",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 770.0, 29.0, 157.0, 116.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 23.0, 29.0, 726.0, 232.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 779.0, 556.0, 148.0, 116.0 ],
					"varname" : "bp.Stereo",
					"viewvisibility" : 1
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-1::obj-110" : [ "Wavetable", "Wavetable", 0 ],
			...
			"obj-8::obj-100" : [ "Offset[2]", "Offset", 0 ],
			...
			"obj-8::obj-25" : [ "WaveCV[1]", "CV", 0 ],
			"obj-11::obj-26" : [ "Decay[1]", "Decay", 0 ],
			"obj-5::obj-20" : [ "mute[1]", "mute", 0 ],
			"obj-11::obj-55" : [ "Mix", "Mix", 0 ],
			"obj-3::obj-96" : [ "Pulse", "Pulse", 0 ],
			"obj-1::obj-100" : [ "Offset", "Offset", 0 ],
			"obj-6::obj-33" : [ "Quadrants", "Quadrants", 0 ],
			"obj-8::obj-80" : [ "BankCV[1]", "CV", 0 ],
			"obj-3::obj-157" : [ "Swing enable", "Swing enable", 0 ],
			"obj-1::obj-154" : [ "CV2", "CV2", 0 ],
			"obj-1::obj-3" : [ "Wave", "Wave", 0 ],
			"obj-11::obj-25" : [ "Damping", "Damping", 0 ],
			"obj-8::obj-110" : [ "Wavetable[1]", "Wavetable", 0 ],
			...
			"obj-1::obj-81" : [ "Bank", "Bank", 0 ],
			"obj-6::obj-80" : [ "Response", "Response", 0 ],
			"obj-10::obj-55" : [ "Bypass[1]", "Bypass", 0 ],
			"obj-4::obj-129" : [ "Tempo", "Tempo", 0 ],
			"obj-7::obj-63" : [ "CV3[1]", "CV3", 0 ],
			"obj-8::obj-3" : [ "Wave[1]", "Wave", 0 ],
			"obj-11::obj-20" : [ "Diffusion", "Diffusion", 0 ],
			"obj-7::obj-55" : [ "power", "power", 0 ],
			"obj-11::obj-1" : [ "Size", "Size", 0 ],
			"obj-1::obj-12" : [ "Mute", "Mute", 0 ],
			"obj-3::obj-185" : [ "Sequence", "Sequence", 0 ],
			"obj-7::obj-4" : [ "Offset[1]", "Offset", 0 ],
			"parameterbanks" : 			{
...
,
				"obj-8::obj-80" : 				{
					"parameter_longname" : "BankCV[1]"
				}
,
				"obj-8::obj-110" : 				{
					"parameter_longname" : "Wavetable[1]"
				}
,
				"obj-8::obj-12" : 				{
			...
			"snapshot" : 			{
				"valuedictionary" : 				{
					"parameter_values" : 					{
						...
						"CV3[1]" : 35.0,
						"DSP" : 1.0,
						"Damping" : 9546.349086594795153,
						"Decay" : 16692.485217612367705,
						"Decay[1]" : 26.100000000000001,
						"Diffusion" : 0.2,
						"Freq[1]" : 5982.831200816293858,
...
,
			"snapshotlist" : 			{
				...
				"entries" : [ 					{
						...
						"origin" : "BEAP_wavetable_forelesing7",
						"type" : "patcher",
						"subtype" : "Undefined",
						"embed" : 1,
						"snapshot" : 						{
...
,
						"fileref" : 						{
							...
							"filepos" : -1,
							"snapshotfileid" : "4c88c777a3dbea6ce4c0e7709a663bbf"
						}
